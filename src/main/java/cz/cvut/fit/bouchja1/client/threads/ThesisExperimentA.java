 ...
 *
 *
 * Tímto experimentem jsem chtěl zjistit, jakým způsobem se bude vyvíjet vnitřní
 * stav algoritmů kolekce, pokud budou jako reakce na doporučení jedním
 * konkrétním algoritmem opakovaně zasílány pozitivní zpětné vazby, zatímco
 * ostatní systémem vybírané metody budou mít vždy pouze 30% šanci pozitivní
 * zpětně vazby.
 */
public class ThesisExperimentA extends Thread {

    private int id;
    private Communication communication;

    public ThesisExperimentA(int name, Communication communication) {
        this.id = name;
