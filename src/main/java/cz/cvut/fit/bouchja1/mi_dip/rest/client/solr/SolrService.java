...
public class SolrService {
    ...
    public void putUserArticle(String coreId, UserArticle userArticle) throws SolrServerException, IOException {
        HttpSolrServer server = getServerFromPool(coreId);
    ...
    private HttpSolrServer getServerFromPool(String coreId) {
    ...
    private void createSolrDocument(HttpSolrServer server, UserArticle userArticle) throws SolrServerException, IOException {
        ...
        doc.addField(RATING, userArticle.getRating());
        server.add(doc);
        UpdateResponse commit = server.commit();
        NamedList<Object> response = commit.getResponse();
    }

    private void updateSolrDocument(HttpSolrServer server, SolrDocumentList docsList, UserArticle userArticle) throws SolrServerException, IOException {
        ...
        newUsers.add(userArticle.getUserId());
