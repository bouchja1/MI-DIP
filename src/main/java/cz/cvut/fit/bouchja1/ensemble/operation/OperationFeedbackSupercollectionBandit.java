 ...
 * @author jan
 */
public class OperationFeedbackSupercollectionBandit extends AbstractOperation {
    ...
    public Reply executeOperation(EnsembleApiFacade api) {
        return api.recalculateFeedbackSupercollection(banditCollectionId, banditId, feedbackValue);
    }
    ...
    public void parseParameters(Map<String, String> parameters) {
        ...
        this.feedbackValue = parameters.get("feedbackType");
    }
