 ...
 * @author jan
 */
public class OperationFeedbackCollectionBandit extends AbstractOperation {
    ...
    public Reply executeOperation(EnsembleApiFacade api) {
        return api.recalculateFeedbackCollection(banditCollectionId, banditId, feedbackValue);
    }
